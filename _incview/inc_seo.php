...
$seoPages = [
    'home' => ['title' => '帥龍萌姬桌布館｜AI 精選 4K 高畫質桌布', 'description' => '探索奇幻、遊戲、動漫與暗色系 4K 高畫質桌布；一句話交給 AI，快速找到適合今天的桌布。', 'keywords' => '4K桌布,高畫質桌布,AI桌布,電腦桌布,手機桌布,桌布下載', 'canonical' => 'https://4k.1-0.tw/'],
    'search' => ['title' => '分類搜尋｜帥龍萌姬桌布館', 'description' => '以主題、風格與關鍵字搜尋奇幻、遊戲、動漫與暗色高畫質桌布。', 'keywords' => '桌布分類,4K桌布搜尋,遊戲桌布,動漫桌布', 'canonical' => 'https://4k.1-0.tw/search.php'],
    ...
    'ranking' => ['title' => '下載排行榜｜帥龍萌姬桌布館', 'description' => '查看本週最受歡迎的 4K 高畫質桌布與熱門下載排行。', 'keywords' => '熱門桌布,桌布排行榜,4K桌布下載', 'canonical' => 'https://4k.1-0.tw/ranking.php'],
