...
<footer>
  <div class="footer-inner">
    ...
    <div><a href="search.php">分類搜尋</a><a href="collection.php"><?php if ($pageKey === 'home'): ?><i class="fa-solid fa-heart favorite-heart-icon" aria-hidden="true"></i><?php endif; ?>我的收藏</a><a href="ranking.php">下載排行榜</a><a href="sitemap">網站地圖</a><a href="advertising">刊登廣告</a></div>
  </div>
    ...
    <div class="visitor-footer-inner">
      <div class="row align-items-center g-3">
        ...
        <div class="col-12 col-md-6 col-xl-2">
          <p class="visitor-footer-note">© 帥龍萌姬桌布館</p>
        </div>
