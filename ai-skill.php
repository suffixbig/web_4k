...
<main id="main-content" tabindex="-1">
    ...
    <section class="skill-rules section" aria-labelledby="androidAppTitle">
      <div class="section-head"><div><p class="section-label">ANDROID APP · v2.1.0</p><h2 id="androidAppTitle">手機選圖，兩步完成</h2></div><p>Android 8.0 以上適用。滑動選一張作品後，只要立即套用或下載圖片。</p></div>
      <div class="rule-cards"><article><i data-lucide="sparkles"></i><h3>AI 技能換桌布</h3><p>在 Windows 使用自然語言搜尋與換桌布，條件不符合時會停止並清楚回報。</p></article><article><i data-lucide="mouse-pointer-click"></i><h3>Android 立即套用</h3><p>手機 App 選圖後按一下，直接把作品設為主畫面桌布。</p></article><article><i data-lucide="download"></i><h3>安裝新版 Android App</h3><p>App 主畫面只保留「立即套用」與「下載圖片」兩個操作按鈕。</p><a class="button primary" href="android-app.php">查看功能並下載 APK</a></article></div>
    </section>
