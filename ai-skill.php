...
<main id="main-content" tabindex="-1">
    ...
    <section class="skill-rules section" aria-labelledby="androidAppTitle">
      <div class="section-head"><div><p class="section-label">ANDROID APP · v2.0.0</p><h2 id="androidAppTitle">手機也能套用動態桌布</h2></div><p>Android 8.0 以上適用。可搜尋、預覽、裁切並分開套用主畫面與鎖定畫面；動態桌布不可見時會自動停止。</p></div>
      <div class="rule-cards"><article><i data-lucide="sparkles"></i><h3>三種動態範例</h3><p>龍焰流光、星界守望、翡翠龍息；先在 App 內預覽，再由 Android 系統套用。</p></article><article><i data-lucide="alarm-clock"></i><h3>06:00 靜態圖排程</h3><p>支援關閉、每週一與每天；只挑手機直式作品，失敗時保留原桌布。</p></article><article><i data-lucide="download"></i><h3>安裝新版 Android App</h3><p>搜尋、預覽、裁切、分開套用、收藏與輪播都已整合在新版 App。</p><a class="button primary" href="android-app.php">查看功能並下載 APK</a></article></div>
    </section>
